		...
		<div className="resume-contact">
			<div className="resume-contact-item">
				<img
					...
					src={process.env.PUBLIC_URL + "/static/social/iphone.svg"} 
					alt="iphone" 
				/>
		    ...
		    <div className="resume-contact-item">
		    	<img 
		    		className="resume-contact-image" 
		    		src={process.env.PUBLIC_URL + "/static/social/email.svg"} 
		    		alt="email" 
		    	/>
		    ...
		    >
		    	<img 
		    		className="resume-contact-image" 
		    		src={process.env.PUBLIC_URL + "/static/social/linkedin.svg"} 
		    		alt="linkedin" 
		    	/>
